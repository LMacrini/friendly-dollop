...
export default function ProjectCards(props) {
  const projects = props.block.content.content[0].content.map((project) => {
    return {
      ...
      description: project.attrs.caption,
      link: { href: project.attrs.href, label: project.attrs.linkLabel },
      logo:
        project.attrs.avatar.version +
        "/" +
        project.attrs.avatar.identifier +
        "/" +
        project.attrs.avatar.name,
    };
  });
  return (
    <ul
